...
const SKILLS = [
  {
    ...
    tags: ['PyTorch', 'HuggingFace', 'DeBERTa-v3', 'BGE-M3', 'ColBERT', 'LoRA/PEFT'],
  },
  {
    category: 'RAG & Agents',
    tags: ['LangGraph', 'Qdrant', 'RAGatouille', 'FastAPI'],
  },
  {
    category: 'Reinforcement Learning',
    tags: ['FinRL-X', 'SAC', 'TD3', 'Stable Baselines 3', 'FinBERT'],
  },
  {
    category: 'Infrastructure',
    tags: ['Docker', 'AWS', 'MLflow', 'Spark', 'Kubernetes'],
  },
  {
    category: 'Languages',
    tags: ['Python', 'Go', 'TypeScript', 'React', 'SQL'],
  },
];
...
export default function Home() {
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            <a
              href="/resume.pdf"
              download
              className="px-6 py-3 bg-blue-500 hover:bg-blue-600 rounded-lg transition font-semibold"
            >
              ↓ Resume
            </a>
            <TerminalButton />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {SKILLS.map((group, i) => (
              <ScrollReveal key={group.category} delay={i * 80}>
                <div className="border border-gray-800 rounded-xl p-5 hover:border-blue-500/50 transition">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {group.tags.map(tag => (
                      <span
                        key={tag}
                        className="px-2 py-1 bg-blue-500/15 text-blue-300 rounded text-xs font-mono"
                      >
                        {tag}
                      </span>
                    ))}
      ...
      <section id="projects" className="bg-black text-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <ScrollReveal delay={0}>
              <div className="border border-gray-800 p-6 rounded-lg hover:border-blue-500 transition h-full">
            ...
            <ScrollReveal delay={160}>
              <div className="border border-gray-800 p-6 rounded-lg hover:border-blue-500 transition h-full">
                <h3 className="text-2xl font-bold mb-3">
                  <a href="https://link.springer.com/chapter/10.1007/978-3-031-31164-2_36" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition">
      ...
      {/* Contact */}
      <section id="contact" className="bg-black text-white py-20 flex items-center">
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="https://www.linkedin.com/in/nirman-taterh/" target="_blank" rel="noopener noreferrer" className="px-6 py-3 border border-blue-500 hover:bg-blue-500/10 rounded-lg transition">
                LinkedIn
              </a>
              <a href="https://github.com/nirmantaterh" target="_blank" rel="noopener noreferrer" className="px-6 py-3 border border-blue-500 hover:bg-blue-500/10 rounded-lg transition">
                GitHub
              </a>
              <a href="https://www.kaggle.com/phiesh7w" target="_blank" rel="noopener noreferrer" className="px-6 py-3 border border-blue-500 hover:bg-blue-500/10 rounded-lg transition">
                Kaggle
              </a>
              <a href="/resume.pdf" download className="px-6 py-3 border border-gray-600 hover:border-gray-400 hover:bg-gray-800 rounded-lg transition text-gray-300">
                ↓ Resume
              </a>
            </div>
          </ScrollReveal>
